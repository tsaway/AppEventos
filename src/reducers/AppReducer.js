...
const AppReducer = (state = initialState, action) => {
    ...
    if (action.type == 'changeEventName') return { ...state, eventName: action.payload.eventName }
    if (action.type == 'changeExpensesRegisted') return { ...state, expensesRegisted: action.payload.expensesRegisted }
