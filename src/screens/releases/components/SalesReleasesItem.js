        ...
        return (
            <View style={styles.main}>
                ...
                <View style={styles.container}>
                    <Text style={styles.title}>Dinheiro: R${this.props.data.money}</Text>
                </View>
                <View style={styles.container}>
                    <Text style={styles.title}>Crédito: R${this.props.data.cardCredit}</Text>
                </View>
                <View style={styles.container}>
                    <Text style={styles.title}>Débito: R${this.props.data.cardDebit}</Text>
                </View>
            </View>
        )
    }
